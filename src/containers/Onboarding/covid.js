...
export default (props) => (
  <div className="onboarding onboarding__travel">
    ...
    <div className="box-options center">
      <div className="box-option variable-size" onClick={()=> props.goNext('covid', 'highschool', props.currentPath)}>
        <img src={PngHighSchool} alt="High School" />
        <span>High School</span>
      </div>
      <div className="box-option variable-size" onClick={()=> props.goNext('covid', 'some college', props.currentPath)}>
        <img src={PngSomeCollege} alt="Some College" />
        <span>Some College</span>
      </div>
      <div className="box-option variable-size" onClick={()=> props.goNext('covid', 'college degree', props.currentPath)}>
        <img src={PngCollegeDegree} alt="College Degree" />
        <span>College Degree</span>
      </div>
      <div className="box-option variable-size" onClick={()=> props.goNext('covid', 'an advanced degree', props.currentPath)}>
        <img src={PngAdvancedDegree} alt="An Advanced Degree" />
        <span>Advanced Degree</span>
      </div>
      <div className="box-option variable-size" onClick={()=> props.goNext('covid', 'a doctorate', props.currentPath)}>
        <img src={PngDoctorate} alt="A Doctorate" />
        <span>Doctorate</span>
      </div>
      <div className="box-option variable-size other" onClick={()=> props.goNext('covid', 'other', props.currentPath)}>
